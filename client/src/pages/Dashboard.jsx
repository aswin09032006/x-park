...
import { Users, Trophy, Award, Shield, Star } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const processGameData = (data) => {
      ...
      setGameStats({ totalScore, badges, gamesPlayed });
  };
  ...
  const statsCards = [
    ...
    { title: 'Certificates', value: '0', icon: Shield, bgColor: 'bg-teal-500' },
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {statsCards.map((card, index) => {
              ...
              // It defines IconComponent before it is used.
